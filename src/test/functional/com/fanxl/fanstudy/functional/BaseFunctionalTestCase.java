 ...
 *******************************************************************************/
package com.fanxl.fanstudy.functional;
...
import com.fanxl.fanstudy.FanStartServer;
...
public class BaseFunctionalTestCase {
	...
	protected static void startJettyOnce() throws Exception {
		if (jettyServer == null) {
			...
			jettyServer = JettyFactory.createServerInSource(new URL(baseUrl).getPort(), FanStartServer.CONTEXT);
			JettyFactory.setTldJarNames(jettyServer, FanStartServer.TLD_JAR_NAMES);
			jettyServer.start();
